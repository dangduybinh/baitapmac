  ...
  switch (timHuongLech())
  {
    case giuaLine:  
      if (huongLech >= lechTrai1 && huongLech <= lechTrai5)
        {
        chayMotor(motorTrai, chayToi, tocDo(80));
        delayMicroseconds(2*DELAY);
        }
      else if (huongLech >= lechPhai1 && huongLech <= lechPhai5)
      {
        chayMotor(motorPhai, chayToi, tocDo(100));
        delayMicroseconds(2*DELAY);
      }
      else
      {
    ...
    case lechPhai3:
      ...
      break;
    case lechPhai4:
      chayMotor(motorTrai, chayToi, tocDo(95));
      chayMotor(motorPhai, chayToi, tocDo(40));
    ...
    default:
      switch (huongLech)
      {
        ...
        case lechPhai4:
        case lechPhai5:
          chayMotor(motorPhai, chayToi, tocDo(10));
          chayMotor(motorTrai, chayToi, tocDo(10));
